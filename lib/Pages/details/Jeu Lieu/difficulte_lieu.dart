...
class DifficulteLieuPage extends StatelessWidget {
  DifficulteLieuPage({super.key});
      ...
      Positioned(
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Europe3Page()),
            );
          },
          style: ElevatedButton.styleFrom(
            backgroundColor: Color.fromRGBO(15, 182, 224, 1),
      ...
      Positioned(
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Europe2Page()),
            );
          },
          style: ElevatedButton.styleFrom(
            backgroundColor: Color.fromRGBO(15, 182, 224, 1),
